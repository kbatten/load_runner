...
class LoadThread(threading.Thread):
    def __init__(self, load_info, server_index, thread_index):
        ...
        # operation info
        self.create = load_info['operation_info']['create_percent'] / gcd(load_info['operation_info']['create_percent'], 100 - load_info['operation_info']['create_percent'])
        self.nocreate = (100 - load_info['operation_info']['create_percent']) / gcd(load_info['operation_info']['create_percent'], 100 - load_info['operation_info']['create_percent'])
        ...
        self.key_prefix = load_info['operation_info'].get('key_prefix', '')
...
class LoadRunner(object):
    def __init__(self, load_info, dryrun=False):
        ...
        for i in range(self.num_threads):
            t = LoadThread(load_info, i % self.num_servers, i)
            t.start()
